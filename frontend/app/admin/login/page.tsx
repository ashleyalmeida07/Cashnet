      ...
      <div className="flex flex-col justify-center items-center p-8 md:p-12">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-2 bg-[color:var(--color-bg-primary)] text-text-tertiary font-mono">Google SSO only</span>
              </div>
            </div>

            <div className="p-3 bg-[rgba(255,56,96,0.05)] border border-[rgba(255,56,96,0.2)] rounded text-xs font-mono text-text-secondary text-center">
              Admin accounts are provisioned by the system. Contact your system operator if you don't have access.
            </div>
          </div>
          ...
          <div className="text-center text-xs font-mono text-text-tertiary">
            ...
            {' · '}
            <Link href="/lender/login" className="text-accent hover:underline">Lender login</Link>
          </div>
        </div>
      </div>
    </div>
