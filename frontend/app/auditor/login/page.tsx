    ...
    <div className="min-h-screen flex bg-[#060a18]">
      ...
      <div className="hidden lg:flex lg:w-[480px] xl:w-[520px] flex-col justify-between p-10 relative overflow-hidden bg-[#0a0f1f]">
        ...
        <svg className="absolute inset-0 w-full h-full opacity-[0.03]" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="hexAu" width="56" height="100" patternUnits="userSpaceOnUse" patternTransform="scale(1.2)">
          ...
          <rect width="100%" height="100%" fill="url(#hexAu)" />
        </svg>
        ...
        <div className="relative z-10 space-y-8">
          <div>
            <p className="text-[11px] uppercase tracking-[0.2em] mb-3" style={{ color: `${ACCENT}99` }}>Auditor Portal</p>
            ...
            <p className="text-sm text-[#5a6478] leading-relaxed mt-3 max-w-[320px]">
              Read-only access to the full audit trail. Monitor events, detect fraud, and export compliance reports.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              { value: '247', label: 'Events' },
              { value: '3', label: 'Alerts' },
              { value: '2h', label: 'Last Audit' },
            ].map((s) => (
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-[380px] space-y-8">
          ...
          <div className="text-center">
            <h2 className="text-xl font-semibold text-white tracking-tight">Auditor Sign In</h2>
          ...
          {accessDenied && (
            <div className="p-4 rounded-xl border border-[#ff386030] bg-[#ff38600a]">
              <p className="text-sm font-medium text-[#ff3860]">Access Denied</p>
              <p className="text-xs text-[#5a6478] mt-1 leading-relaxed">
                Your Google account is not provisioned as an auditor. Contact the system operator.
              </p>
              <Link href="/login?role=BORROWER" className="text-xs mt-2 inline-block hover:underline text-[#00d4ff]">
          ...
          <div className="rounded-xl border border-[#1e2540] bg-[#0c1224] p-6 space-y-5">
            ...
            <p className="text-center text-xs text-[#5a6478]">
              Need access?{' '}
              <Link href="/auditor/signup" className="font-medium hover:underline" style={{ color: ACCENT }}>Request access &rarr;</Link>
            </p>
          </div>
